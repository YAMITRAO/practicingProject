...
const Project = () => {
    let dataDummy = [
        {itemName:"Laptop", LocationOfExpenditure:"Delhi", itemDate:new Date("10-12-2023"), itemRate:12000},
        {itemName:"Mobile", LocationOfExpenditure:"Jaipur", itemDate:new Date("09-05-2023"), itemRate:10000},
        {itemName:"Screen", LocationOfExpenditure:"Raipur", itemDate:new Date("07-12-2022"), itemRate:15000}
      ]
    ...
    <ExpenseForm importedDataFromExpenseForm={importedData}/>
      ...
      <Chart renderedData = {updatedData}/>
